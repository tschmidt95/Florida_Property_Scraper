...
def get_provider_catalog(county: str) -> list[ProviderCatalogEntry]:
    ...
    entries: list[ProviderCatalogEntry] = [
        ProviderCatalogEntry(
            county=key,
            provider_id="fdor_statewide_centroids",
            category="parcels",
            method="api",
            supports_counties=supports,
            target_ids=[],
            base_url="https://services9.arcgis.com/Gh9awoU677aKree0/arcgis/rest/services/Florida_Statewide_Parcel_Centroid_Version/FeatureServer/0",
            supported_fields=[
                "parcel_id",
                "owner_name",
                "situs_address",
            ...
            status="implemented",
            notes="Statewide centroid + owner/address base feed",
        ),
        ProviderCatalogEntry(
            county=key,
        ...
        ProviderCatalogEntry(
            county=key,
            provider_id="pa_photo",
            category="photos",
            method="html",
            supports_counties=supports,
            target_ids=["pa"],
            base_url="",
            supported_fields=["photo_url"],
            rate_limit={"requests_per_min": 30},
            status="implemented",
            notes="Property appraiser parcel photo when available",
        ),
        ProviderCatalogEntry(
            county=key,
